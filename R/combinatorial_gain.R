#' @title combinatorial gain
#' @author Girish Pulinkala
#' @description calculates combinatorial gain for each rule generated
#' @import tidyverse
#' @import data.table
#' @import tibble
#' @import stringr
...
#' @param rules A rule set that was generated using the training set
#' @examples
#' # example code
#' #ros<-rosetta(autcon)
#' #rules<-ros$main
...
combinatorial_gain<-function(data,rules){
